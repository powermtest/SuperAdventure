...
namespace SuperAdventure
{
    public partial class SuperAdventure : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.QuestAvailableHere != null)
            {
                ...
                if (playerAlreadyHasQuest)
                {
                    ...
                    if (!playerAlreadyCompletedQuest)
                    {
                        ...
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessages.AppendText("You complete the '" + newLocation.QuestAvailableHere.Name +
                            ...
                            rtbMessages.AppendText(newLocation.QuestAvailableHere.RewardExperiencePoints.ToString() +
                                                   " experience points" + Environment.NewLine);
                            rtbMessages.AppendText(newLocation.QuestAvailableHere.RewardGold.ToString() + " gold" +
                                                   Environment.NewLine);
                ...
                else
                {
                    ...
                    rtbMessages.Focus();
                    rtbMessages.AppendText("You receive the " + newLocation.QuestAvailableHere.Name + " quest." +
                                           Environment.NewLine);
                    ...
                    foreach (QuestCompletionItem qci in newLocation.QuestAvailableHere.QuestCompletionItems)
                    {
                        ...
                        {
                            rtbMessages.Focus();
                            rtbMessages.AppendText(qci.Quantity.ToString() + " " + qci.Details.NamePlural +
                                                   Environment.NewLine);
                            rtbMessages.ScrollToCaret();
        ...
        private void btnUseWeapon_Click(object sender, EventArgs e)
        {
            ...
            // Display message
            rtbMessages.Focus();
            rtbMessages.AppendText("You hit the " + _currentMonster.Name + " for " + damageToMonster.ToString() +
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                rtbMessages.Focus();
                rtbMessages.AppendText("You receive " + _currentMonster.RewardExperiencePoints.ToString() +
                                       " experience points" + Environment.NewLine);
                rtbMessages.ScrollToCaret();
                ...
                rtbMessages.Focus();
                rtbMessages.AppendText("You receive " + _currentMonster.RewardGold.ToString() + " gold" +
                                       Environment.NewLine);
                rtbMessages.ScrollToCaret();
